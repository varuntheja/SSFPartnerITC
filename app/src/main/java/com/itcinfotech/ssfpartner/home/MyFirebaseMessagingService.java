...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        sendNotification("SSF Notification Testing...");
    }
    ...
    private void sendRegistrationToServer(String token) {
        ...
        Call<ApprovalsHelper> call = apiService.updateToken(SessionManager.getInstance(this).getSessionToken(), request);
            ...
            public void onResponse(Call<ApprovalsHelper> call, Response<ApprovalsHelper> response) {
                if (response != null && response.isSuccessful()) {
                    if (response.body() != null) {
                        SessionManager.getInstance(MyFirebaseMessagingService.this).setTokenUpdated(true);
                    }
                    else {
                        SessionManager.getInstance(MyFirebaseMessagingService.this).setTokenUpdated(false);
                    }
                }
